    ...
    <div className='bg-white rounded-md p-4 flex flex-col items-center w-full gap-3'>
      ...
      <div className='bg-blue-100 border-blue-200 border rounded-md p-4 text-sm text-blue-800 mt-4'>
        ...
        <div className='mt-4'>
          ...
          <span>
            Thành viên muốn đăng bài hoặc gia hạn bài đăng thì xin vui lòng liện
            hệ với Admin theo thông tin bên dưới. Chúc mọi người ngày mới làm
            việc hiệu quả.
          </span>
        </div>
      </div>
